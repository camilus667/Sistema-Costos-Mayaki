...
import { POS_GRUPOS_REPORTE, POS_GRUPO_REFERENCIA, POS_CATEGORIAS_REFERENCIA, POS_TALLA_GENERICO, POS_COLUMNA_UNICA, } from '@sistema-uniformes/shared';
...
export function limpiarNombreProducto(nombre) {
...
function resolverIndiceColumna(cabecera, candidatas, indicePorDefecto) {
...
export async function importarArchivoPos(buffer) {
    ...
    const ordenPorProductoMap = new Map();
    ...
    for (let i = headerRowIndex + 1; i < rawData.length; i++) {
        ...
        if (POS_CATEGORIAS_REFERENCIA.includes(rawCategoria)) {
...
//# sourceMappingURL=posImport.service.js.map